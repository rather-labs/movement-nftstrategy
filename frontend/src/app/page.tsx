...
const features = [
  {
    ...
    description:
      'Sweep the floor programmatically, relist at a premium, and auto-route sale proceeds back to the treasury—accruing MOVE without manual management.',
    icon: RepeatIcon,
  },
  {
  ...
  },
  {
    ...
    description:
      'No off-chain servers. Contracts live entirely on Movement blockchain. Execute from any wallet with built-in type-safe transactions.',
    icon: LockIcon,
  },
];
...
const phases = [
  {
    ...
    copy: 'The strategy treasury buys the lowest-priced NFT from the collection on Movement.',
  },
  {
  ...
  },
  {
    ...
    copy: 'When the relisted NFT sells, the MOVE flows through the pool, swaps to RATHER, and the purchased RATHER is burned—reducing supply while refueling the treasury.',
  },
];
    ...
    >
      <Container maxW="6xl">
        <Stack spacing={{ base: 12, md: 16 }}>
          ...
          >
            <MotionHeading size={{ base: 'xl', md: '2xl' }} maxW="4xl" variants={fadeInUp}>
            ...
            <MotionText
              ...
              variants={fadeInUp}
            >
              A looping NFT accumulation engine built on Movement. Automate floor sweeps. Capture
              the spread. Burn the supply. Non-custodial, fully on-chain, and built for
              composability.
            </MotionText>
            <MotionHStack spacing={4} flexWrap="wrap" justify="center" variants={fadeInUp}>
              <Button
                as={NextLink}
                href="/strategy"
                size="lg"
          ...
          <MotionStack
            ...
            variants={scaleIn}
          >
            <MotionHeading size="lg" textAlign={{ base: 'left', md: 'center' }} variants={fadeIn}>
              How the flywheel spins
            </MotionHeading>
            <MotionSimpleGrid columns={{ base: 1, md: 3 }} spacing={6} variants={staggerContainer}>
              {phases.map((phase, index) => (
                <MotionStack key={phase.title} spacing={3} variants={slideInFromLeft}>
                  <motion.div
          ...
          >
            ...
            <MotionHStack spacing={6} flexWrap="wrap" justify="center" variants={staggerContainer}>
          ...
          >
            ...
            <MotionText maxW="2xl" variants={fadeInUp}>
              Connect your wallet, monitor treasury health, and trigger buys or burns in a few
